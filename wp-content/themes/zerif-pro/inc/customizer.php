...
function wp_themeisle_customize_register( $wp_customize ) {
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ) :
		...
		/***************************************/
		 ...
		 /* zerif_bigtitle_thirdbutton_label */
        $wp_customize->add_setting( 'zerif_bigtitle_thirdbutton_label', array(
            'sanitize_callback' => 'zerif_sanitize_input',
            'default' => __( 'Another button','zerif' ),
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_bigtitle_thirdbutton_label', array(
            'label'    => __( 'Third button label', 'zerif' ),
            'description' => __( 'This is the text that will appear on the third button','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 5,
        ));

        /* zerif_bigtitle_thirdbutton_url */
        $wp_customize->add_setting( 'zerif_bigtitle_thirdbutton_url', array(
            'sanitize_callback' => 'esc_url',
            'default' => '#',
            'transport' => 'postMessage'
        ));

        $wp_customize->add_control( 'zerif_bigtitle_thirdbutton_url', array(
            'label'    => __( 'Third button link', 'zerif' ),
            'description' => __( 'The third button is linked to this URL','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 6,
        ));
		
		 /* zerif_bigtitle_fourthbutton_label */
		$wp_customize->add_setting( 'zerif_bigtitle_fourthbutton_label', array(
            'sanitize_callback' => 'zerif_sanitize_input',
            'default' => __( 'Another button','zerif' ),
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_bigtitle_fourthbutton_label', array(
            'label'    => __( 'Fourth button label', 'zerif' ),
            'description' => __( 'This is the text that will appear on the fourth button','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 5,
        ));

        /* zerif_bigtitle_fourthbutton_url */
        $wp_customize->add_setting( 'zerif_bigtitle_fourthbutton_url', array(
            'sanitize_callback' => 'esc_url',
            'default' => '#',
            'transport' => 'postMessage'
        ));

        $wp_customize->add_control( 'zerif_bigtitle_fourthbutton_url', array(
            'label'    => __( 'Fourth button link', 'zerif' ),
            'description' => __( 'The fourth button is linked to this URL','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 6,
        ));
		
		
		 /* zerif_bigtitle_fifthbutton_label */
		$wp_customize->add_setting( 'zerif_bigtitle_fifthbutton_label', array(
            'sanitize_callback' => 'zerif_sanitize_input',
            'default' => __( 'Another button','zerif' ),
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_bigtitle_fifthbutton_label', array(
            'label'    => __( 'fifth button label', 'zerif' ),
            'description' => __( 'This is the text that will appear on the fifth button','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 5,
        ));

        /* zerif_bigtitle_fifthbutton_url */
        $wp_customize->add_setting( 'zerif_bigtitle_fifthbutton_url', array(
            'sanitize_callback' => 'esc_url',
            'default' => '#',
            'transport' => 'postMessage'
        ));

        $wp_customize->add_control( 'zerif_bigtitle_fifthbutton_url', array(
            'label'    => __( 'fifth button link', 'zerif' ),
            'description' => __( 'The fifth button is linked to this URL','zerif' ),
            'section'  => 'zerif_bigtitle_texts_section',
            'priority'    => 6,
        ));
        ...
        /* zerif_bigtitle_fouthbutton_url */
        $wp_customize->add_setting( 'zerif_bigtitle_fourthbutton_url', array(
            'sanitize_callback' => 'esc_url_raw',
            'default' => '#'
        ) );
